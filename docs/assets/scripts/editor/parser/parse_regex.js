...
function RegexParser() {
  ...
  function init_object(raw_regex_input, e, language) {
    ...
    if (i._parentGroup) init_object.RegexSyntaxThrows.push({
  ...
  var names_unicodeEscape =
    "unicodeEscape1,unicodeEscape2,unicodeEscape3,unicodeEscape4";
  var names_charsetUnicodeHexEscape =
  ...
  var python_validStructs = {
    ...
    trans: base_validStructs.trans.concat([
      ...
      [
        "groupNamedContent>groupNamedEnd",
        "0-9a-zA-Z_",
        elementsCallback.groupNamedContent
      ],
