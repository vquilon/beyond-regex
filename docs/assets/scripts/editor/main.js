...
`,d.innerText=t),e.reLang?J(e.reLang):J("python"),H()),{parseRegex:I,getRegex:B,parseSharedRegex:(r,n="python")=>{var a,o,s,e=null;try{e=$.parse(r,c,n)}catch(t){if(!(t instanceof $.parse.RegexSyntaxError))throw t;{n=r;let e="";"number"==typeof(r=t).lastIndex&&(a=R(n.slice(0,r.lastIndex)),o=R(n[r.lastIndex]),n=R(n.slice(r.lastIndex+1)),s=location.origin+"/beyond-regex/",editLink=s+`#!flags=${P()}&re=${encodeURIComponent(O())}&reLang=${D()}"`,e=`
            ...
            `,showCancelButton:!0,showConfirmButton:!1,showCloseButton:!0,cancelButtonText:"Close"})}}return e},trim:n,getParams:q,getCorrectedFlags:P,getCorrectedReLanguage:D,getCorrectedRegex:O,_updateRaphaelItemsJSON:e=>{T(document.querySelector("#"+L),e)},$containerEditor:i,$input:a}};