var RegexVisualizerPanel=function(a){var r=document.getElementById("visualizeClick"),e=document.getElementById("exportIt");let s=a.editorParser.$containerEditor;var t,n=!s&&!r;n&&(t=a.editorParser.parseSharedRegex);const i=a.editorParser.getCorrectedReLanguage,o=a.editorParser.getCorrectedFlags,l=a.editorParser.getCorrectedRegex,c=a.editorParser._updateRaphaelItemsJSON;var d,u,p,m=document.querySelector("#"+a.loader_view_id),g=m.querySelector("."+a.progress_bar_class),h=new Raphael("visualizer-graphView",10,10);h.canvas.id="visualizer-graphSVG";const f=()=>{s.regexson||a.editorParser.parseRegex(a.editorParser.getRegex());var e,t=s.regexson;return t&&0===t.errors.length?(r.disabled=!0,m.classList.add("loading"),g.updateProgressBar=function(e){this.attributes.getNamedItem("data-value").value=""+e,this.style.transform=`scaleX(${e/100})`},window.setTimeout(()=>{e=RegexVisualizer(t,o(),h,g),c(e),p&&p(),[d,u,p]=CustomThumbnailSVGControl({mainViewId:"visualizer-graphView",mainSVGId:"visualizer-graphSVG",thumbContainerId:"thumbViewContainer"}),m.classList.remove("loading"),g.attributes.getNamedItem("data-value").value="0",g.style.transform="",r.disabled=!1},0),!0):!(r.disabled=!0)};function v(e=!1){var t=l(),a=o(),r=i();let s=location.href;var n=s.indexOf("#");s=0<n?s.slice(0,n):s,s+="panels/visualizer";return e?`<iframe frameborder="0" 
                width="500px" height="300px" 
                src="${s}#!embed=true&flags=${a}&re=${encodeURIComponent(t)}&reLang=${r}">
                </iframe>`:`${s}#!embed=true&flags=${a}&re=${encodeURIComponent(t)}&reLang=`+r}function y(e){return(new XMLSerializer).serializeToString(e)}const w=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),S=async(c,d,u,e="svg")=>{let p=h.canvas.cloneNode(!0),t=p.querySelector("g#mainSVGViewPort"),a=(t.removeAttribute("transform"),t.removeAttribute("style"),t.querySelector("g#mainSVGContainer")),r=(a.removeChild(a.querySelector("desc")),a.removeChild(a.querySelector("defs")),a.firstElementChild);r.style.stroke="none",r.style.strokeWidth="";var s=(e,t,n="",a="",i="")=>{e.style.fill=n||e.style.fill||e.getAttribute("fill"),e.style.stroke=a||e.style.stroke||e.getAttribute("stroke"),e.style.strokeWidth=i||e.style.strokeWidth||e.getAttribute("stroke-width"),n=window.devicePixelRatio||1;let o=parseFloat(e.getAttribute("width")),l=parseFloat(e.getAttribute("height"));if(p.removeAttribute("xmlns:xlink"),"svg"===t&&(a="data:image/svg+xml,"+encodeURIComponent(y(p)),d.setAttribute("src",a),u.setAttribute("href",a)),"png"===t){i=p.outerHTML,c.width=o*n,c.height=l*n;let t=c.getContext("2d"),a=(t.setTransform(n,0,0,n,0,0),y(p),self.URL||self.webkitURL||self),r=new Image,s=(e=new Blob([i],{type:"image/svg+xml;charset=utf-8"}),a.createObjectURL(e));r.onload=function(){t.drawImage(r,0,0,o,l);var e=c.toDataURL("image/png");a.revokeObjectURL(s),d.setAttribute("src",e),u.setAttribute("href",e)},r.src=s}};return s(r,e),{$img:d,rectBackground:r,updateBackgroundStyle:s}};return document.querySelector("#share-visualize").addEventListener("click",e=>{const t=new Promise(e=>{e({panelIframeURL:v(iframe=!0),panelURL:v(iframe=!1)})});t.then(e=>{Swal.fire({title:"Share the interactive graph!",icon:"info",iconHtml:'<span class="sweetalert-icon material-icons">image</span>',html:`
                ...
                `,showCancelButton:!0,showConfirmButton:!1,showCloseButton:!0,cancelButtonText:"Close",didOpen:()=>{Swal.showLoading();var{}=S(document.querySelector("canvas#export-image"),document.querySelector("img#exported-img"),document.querySelector("img#exported-img").parentElement,imageType="png");Swal.hideLoading()}})}),f()),{generatePanelURL:v}};