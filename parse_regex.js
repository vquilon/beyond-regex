 ...
 class NFA {
  ...
  var validStructs = {
    ...
    trans: [
      ...
      [names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ",start,begin,end,exact,repeatNonGreedy,repeat0,repeat1,repeat01,groupStart,groupQualifiedStart,choice,repeatn>exact", ".", v.dot],
      ["start,groupStart,groupQualifiedStart,end,begin,exact,repeat0,repeat1,repeat01,repeatn,repeatNonGreedy,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">begin", "^", v.assertBegin],
      [names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ",exact>repeatnStart", "{", v.repeatnStart],
      ...
      ["exact," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">repeat0", "*", v.repeat0ToInf],
      ["exact," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">repeat1", "+", v.repeat1ToInf],
      ["exact," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">repeat01", "?", v.repeat0To1],
      ...
      ["start,begin,end,groupStart,groupQualifiedStart,exact,repeatNonGreedy,repeat0,repeat1,repeat01,repeatn,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">escape", "\\", v.escapeStart],
      ...
      ["unicodeEscape1>unicodeEscape2", charset_hex, v.exact],
      ["unicodeEscape2>unicodeEscape3", charset_hex, v.exact],
      ["unicodeEscape3>unicodeEscape4", charset_hex, v.exact],
      ["unicodeEscape4>exact", charset_hex, v.unicodeEscape],
      ["escape>hexEscape1", "x", v.exact],
      ["hexEscape1>hexEscape2", charset_hex, v.exact],
      ["hexEscape2>exact", charset_hex, v.hexEscape],
      ["escape>digitBackref", "1-9", v.backref],
      ["digitBackref>digitBackref", "0-9", v.backref],
      ["digitBackref>exact", "^+*?^$.|(){[\\0-9", v.exact],
      ["exact,begin,end,repeat0,repeat1,repeat01,repeatn,repeatNonGreedy,start,groupStart,groupQualifiedStart,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">groupStart", "(", v.groupStart],
      ...
      ["groupQualify>groupQualifiedStart", "!", v.groupToAssertion],
      [names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ",groupStart,groupQualifiedStart,begin,end,exact,repeat1,repeat0,repeat01,repeatn,repeatNonGreedy,choice>exact", ")", v.groupEnd],
      ["start,begin,end,groupStart,groupQualifiedStart,exact,repeat0,repeat1,repeat01,repeatn,repeatNonGreedy,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">choice", "|", v.choice],
      ["start,groupStart,groupQualifiedStart,begin,exact,repeat0,repeat1,repeat01,repeatn,repeatNonGreedy,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">end", "$", v.assertEnd],
      ["exact,begin,end,repeat0,repeat1,repeat01,repeatn,repeatNonGreedy,groupQualifiedStart,groupStart,start,choice," + names_repeat + ",nullChar,digitBackref," + names_unicodeEscape + "," + names_hexEscape + ">charsetStart", "[", v.charsetStart],
      ...
      ["charsetUnicodeEscape1>charsetUnicodeEscape2", charset_hex, v.charsetContent],
      ["charsetUnicodeEscape2>charsetUnicodeEscape3", charset_hex, v.charsetContent],
      ["charsetUnicodeEscape3>charsetUnicodeEscape4", charset_hex, v.charsetContent],
      ["charsetUnicodeEscape4>charsetContent", charset_hex, v.charsetUnicodeEscape],
      ["charsetEscape>charsetHexEscape1", "x", v.charsetContent],
      ["charsetHexEscape1>charsetHexEscape2", charset_hex, v.charsetContent],
      ["charsetHexEscape2>charsetContent", charset_hex, v.charsetHexEscape],
      [names_charsetUnicodeEscape + ">charsetContent", "^\\]0-9a-fA-F-", v.charsetContent],
      [names_charsetUnicodeEscape + ",charsetNullChar,charsetContent>charsetRangeStart", "-", v.charsetContent],
      ...
      ["charsetRangeEndUnicodeEscape1>charsetRangeEndUnicodeEscape2", charset_hex, v.charsetContent],
      ["charsetRangeEndUnicodeEscape2>charsetRangeEndUnicodeEscape3", charset_hex, v.charsetContent],
      ["charsetRangeEndUnicodeEscape3>charsetRangeEndUnicodeEscape4", charset_hex, v.charsetContent],
      ["charsetRangeEndUnicodeEscape4>charsetRangeEnd", charset_hex, v.charsetRangeEndUnicodeEscape],
      ["charsetRangeEndEscape>charsetRangeEndHexEscape1", "x", v.charsetRangeEnd],
      ["charsetRangeEndHexEscape1>charsetRangeEndHexEscape2", charset_hex, v.charsetContent],
      ["charsetRangeEndHexEscape2>charsetRangeEnd", charset_hex, v.charsetRangeEndHexEscape],
      ...
      ["groupNamedStart,groupNamedContent>groupNamedContent", "0-9a-zA-Z_",  v.groupNamedContent],
      ["groupNamedContent>groupNamedEnd", "0-9a-zA-Z_",  v.groupNamedContent],
