...
function completely(container, config) {
    ...
    config.idInput =                        config.idInput || '';
    config.classNameInput =                 config.classNameInput || '';
    config.initValue =                      config.initValue || '';

    var txtInput = document.createElement('input');
    if(config.idInput) document.getElementById(config.idInput).remove()

    // AGREGADO: Para asignarle un id y clase
    txtInput.id = config.idInput;
    txtInput.classNme = config.classNameInput;
    txtInput.initValue = config.initValue;
